...
public final class RatPolyStack implements Iterable<RatPoly> {
    ...
    public void dup() {
        // TODO: Fill in this method, then remove the RuntimeException
        //peek which element is on the top and push it again.
    ...
    public void swap() {
        // TODO: Fill in this method, then remove the RuntimeException
        RatPoly rp1 = polys.pop();
        RatPoly rp2 = polys.pop();
        polys.push(rp1);
        polys.push(rp2);
        checkRep();
    ...
    public RatPoly getNthFromTop(int index) {
        // TODO: Fill in this method, then remove the RuntimeException
        // we can compute, how deep our element is located with the stack by saying:
        int elmtToGet = (polys.size() - 1) - index;
        // then get that element by using the get method
        return polys.get(elmtToGet);
